...
# --- 3. CSS (FUNDO BRANCO + MENU SUPERIOR DIREITO) ---
st.markdown("""
    <style>
    .stApp { background-color: #FFFFFF !important; color: #333333 !important; }
    
    /* LOGO: GERAL (AZUL) JÁ (LARANJA) */
    .logo-container { text-align: center; padding: 10px; margin-top: 20px; }
    ...
    [data-testid="stSidebar"] { display: none; } /* Esconde a sidebar padrão */
...
# --- 4. MENU SUPERIOR DIREITO (VISÍVEL) ---
# Usamos colunas para empurrar o botão de login para a direita
top_col1, top_col2 = st.columns([4, 1])
with top_col2:
    # Um pequeno botão ou expander para login
    with st.popover("🔑 Entrar"):
...
# ETAPA RESULTADO
    ...
    st.image(f"https://api.mapbox.com/styles/v1/mapbox/streets-v11/static/-46.6682,-23.7721,13/600x220?access_token=pk.eyJ1IjoiZ3VpZG94IiwiYSI6ImNrZnduZnR4MDBhNnoycnBnbm9idG9yejkifQ.7Wp6M_2yA6_z_rG-vH0Z6A")
