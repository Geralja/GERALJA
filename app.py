...
profissoes_completas = [
    ...
    "Jornalista de TV", "Fotógrafo", "DJ", "Cantor(a)", "Designer de Interiores", "Corretor de Imóveis"
     "Advogado" ("Jurista", "Consultor Jurídico", "Defensor")
 "Médico" ("Dotor", "Clínico", "Profissional de Saúde")
 "Professor" ("Educador", "Docente", "Instrutor")
 "Engenheiro" ("Técnico", "Especialista", "Projetista")
 "Arquiteto" ("Desenhista", "Projetista", "Planejador")
 "Contador" ("Auditor", "Contabilista", "Especialista em Finanças")
 "Psicólogo" ("Terapeuta", "Conselheiro", "Especialista em Comportamento")
 "Enfermeiro" ("Cuidador", "Atendente", "Profissional de Enfermagem")
 "Dentista" ("Odontólogo", "Especialista em Saúde Bucal")
 "Veterinário" ("Médico de Animais", "Especialista em Saúde Animal")
 "Motorista" ("Condutor", "Piloto", "Chauffeur")
 "Coador" ("Ajudante", "Auxiliar", "Assistente")
 "Garçom" ("Atendente", "Servidor", "Balconista")
 "Cheiro" ("Especialista em Perfumes", "Perfumista")
 "Padeiro" ("Confeiteiro", "Pâtissier", "Bolacheiro")
 "Confeiteiro" ("Padeiro", "Bolacheiro", "Docceiro")
 "Pintor" ("Artista", "Desenhista", "Colorista")
 "Escritor" ("Autor", "Romancista", "Jornalista")
 "Artista" ("Criador", "Expressivo", "Talento")
 "Músico" ("Instrumentista", "Cantor", "Compositor")
 "Programador" ("Desenvolvedor", "Codificador", "Técnico em Informática")
 "Desenvolvedor" ("Programador", "Criador", "Projetista")
 "Analista" ("Especialista", "Consultor", "Perito")
 "Cientista" ("Pesquisador", "Investigador", "Especialista")
 "Matemático" ("Especialista em Matemática", "Geômetra")
 "Físico" ("Cientista", "Especialista em Física")
 "Químico" ("Cientista", "Especialista em Química")
 "Biólogo" ("Cientista", "Especialista em Biologia")
 "Geólogo" ("Cientista", "Especialista em Geologia")
"Astrônomo" ("Cientista", "Especialista em Astronomia")
 "Historiador" ("Pesquisador", "Especialista em História")
 "Filósofo" ("Pensador", "Especialista em Filosofia")
 "Sociólogo" ("Cientista Social", "Especialista em Sociologia")
 "Economista" ("Especialista em Economia", "Analista Financeiro") "Administrador" ("Gerente", "Diretor", "Líder")
 "Gerente" ("Administrador", "Diretor", "Líder")
 "Diretor" ("Líder", "Gerente", "Administrador")
 "Líder" ("Diretor", "Gerente", "Administrador")
 "Empresário" ("Empreendedor", "Negociante", "Comerciante")
 "Empreendedor" ("Empresário", "Negociante", "Comerciante")
 "Trabalhador" ("Operário", "Funcionário", "Colaborador")
 "Operário" ("Trabalhador", "Funcionário", "Colaborador")
 "Técnico" ("Especialista", "Perito", "Profissional")
 "Mecânico" ("Técnico", "Especialista", "Reparador")
 "Eletricista" ("Técnico", "Especialista", "Instalador")
 "Engenheiro de Som" ("Técnico", "Especialista", "Áudio")
 "Iluminador" ("Técnico", "Especialista", "Luz")
 "Cameraman" ("Operador de Câmera", "Técnico", "Fotógrafo")
 "Fotógrafo" ("Artista", "Especialista", "Imagem")
 "Jornalista" ("Repórter", "Comunicador", "Escritor")
 "Redator" ("Escritor", "Jornalista", "Comunicador")
 "Editor" ("Revisor", "Publicador", "Produtor")
 "Revisor" ("Editor", "Corretor", "Verificador")
 "Tradutor" ("Intérprete", "Linguista", "Especialista em Idiomas")
 "Intérprete" ("Tradutor", "Linguista", "Especialista em Idiomas")
 "Professor de Idiomas" ("Linguista", "Especialista", "Instrutor")
 "Tutor" ("Professor", "Instrutor", "Mentor")
 "Coach" ("Mentor", "Treinador", "Orientador")
 "Mentor" ("Tutor", "Coach", "Orientador")
 "Consultor" ("Especialista", "Perito", "Analista")
 "Designer" ("Artista", "Criador", "Projetista")
 "Arquiteto de Interiores" ("Decorador", "Projetista", "Especialista")
 "Decorador" ("Arquiteto de Interiores", "Projetista", "Especialista")
 "Paisagista" ("Jardineiro", "Projetista", "Especialista")
 "Jardineiro" ("Paisagista", "Cuidador", "Especialista")
 "Agricultor" ("Fazendeiro", "Produtor", "Especialista")
 "Pecuarista" ("Fazendeiro", "Produtor", "Especialista")
 "Pescador" ("Caçador", "Produtor", "Especialista")
 "Caçador" ("Pescador", "Produtor", "Especialista")
 "Geógrafo" ("Cartógrafo", "Especialista", "Analista")
 "Cartógrafo" ("Geógrafo", "Especialista", "Analista")
 "Topógrafo" ("Especialista", "Analista", "Técnico")
 "Aviador" ("Piloto", "Especialista", "Comandante")
 "Navegador" ("Piloto", "Especialista", "Comandante")
