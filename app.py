...
with menu_abas[3]:
    ...
    if not st.session_state.admin_logado:
        ...
        # Define as abas dentro do ambiente logado
        ...
        with tab_recibos:
            ...
            st.markdown("""
                ...
                .marca-dagua {
                    ...
                    font-size: 60px; color: rgba(0, 71, 171, 0.05); 
            ...
            if btn_gerar:
                if nome_c and pacote_c:
                    ...
                    # HTML com a Marca d'água de volta
                    html_recibo = f"""
                    ...
                    # 1. BOTÃO DE DOWNLOAD (Gera um TXT/HTML que pode ser salvo como arquivo)
                    # Para enviar arquivo no Zap, você baixa ele aqui e anexa lá.
                    st.download_button(
                        label="📥 BAIXAR RECIBO (HTML/PDF)",
                        data=html_recibo,
                        file_name=f"Recibo_{nome_c.replace(' ', '_')}.html",
                        mime="text/html",
                        use_container_width=True
                    )
                    
                    # 2. BOTÃO DE WHATSAPP (Aviso profissional)
                    ...
                    st.error("Preencha os dados para gerar.")
# ==============================================================================
# ABA 5: FEEDBACK
# ==============================================================================
with menu_abas[4]:
